...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="{{ $class ?? '' }}">
          ...
          <div class="dropdown show-dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="button-container">
                <a href="https://www.creative-tim.com/product/public-dashboard-laravel" target="_blank" class="btn btn-primary btn-block">Free Download</a>
              </li>
        ...
        <script src="{{ asset('dist') }}/js/core/bootstrap-public-design.min.js"></script>
