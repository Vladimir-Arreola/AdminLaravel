@extends('layouts.applogin', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Topicos 21b')])

@section('content')
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
      <h3>{{ __('Inicio de sesión de nuestra APP.') }} </h3>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
            <p class="card-description text-center">{{ __('Para loguearte un correo  ') }} <strong>admin@material.com</strong> {{ __(' y la contraseña ') }}<strong>secret</strong> </p>
